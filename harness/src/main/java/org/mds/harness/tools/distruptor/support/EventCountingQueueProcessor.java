 ...
 */
package org.mds.harness.tools.distruptor.support;
...
public final class EventCountingQueueProcessor implements Runnable
{
    ...
    public EventCountingQueueProcessor(final BlockingQueue<Long> blockingQueue, final PaddedLong[] counters, final int index,final long interval)
    {
        this.blockingQueue = blockingQueue;
        this.counters = counters;
        this.index = index;
